...
(
    ...
    FOREIGN KEY (from_station_name) REFERENCES Station(name) ON DELETE CASCADE ON UPDATE CASCADE,
    FOREIGN KEY (to_station_name) REFERENCES Station(name) ON DELETE CASCADE ON UPDATE CASCADE,
